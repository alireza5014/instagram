        ...
        <div class="navbar-content scroll-div">
            <div class="vz_navigation">
                <ul class="sidebar nav flex-column">
                    ...
                    <li><a class="nav-link text-center" href="{{route('user.post.list')}}" data-nav="ui_features"><i class="feather ft-gitlab"></i><span> بلاگ ها </span></a></li>
                     <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="advance_kit"><i class="feather ft-zap"></i><span>  نرخ ها</span></a></li>
                    <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="forms"><i class="feather ft-clipboard"></i><span> تجهیزات</span></a></li>
                    <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="maps"><i class="feather ft-map-pin"></i><span>   خدمات </span></a></li>
                    <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="data"><i class="feather ft-file-text"></i><span>تماس با ما</span></a></li>
                    <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="pages"><i class="feather ft-layers"></i><span>درباره ما</span></a></li>
                </ul>
                    ...
                    {{--<div class="vz_sidebar_link ui_features">--}}
                        {{--<ul class="nav vz_inner_nav">--}}
                            {{--<li class="nav-item menu_title">--}}
                                {{--<label>  بلاگ ها </label>--}}
                            {{--</li>--}}
                            {{--<li class="nav-item"><a class="nav-link" href="{{route('user.post.new')}}"><i class="menu_icon ti-alert"></i><span>ایجاد بلاگ جدید</span></a></li>--}}
                            {{--<li class="nav-item"><a class="nav-link" href="{{route('user.post.list')}}"><i class="menu_icon ti-alert"></i><span>  لیست بلاگ ها  </span></a></li>--}}
                    ...
                    {{--<div class="vz_sidebar_link advance_kit">--}}
                        {{--<ul class="nav vz_inner_nav">--}}
                            {{--<li class="nav-item menu_title">--}}
                                {{--<label>نرخ ها  </label>--}}
                            {{--</li>--}}
                            {{--<li class="nav-item"><a class="nav-link" href="toastr.html"><i class="menu_icon ti-layout-cta-left"></i> <span>ایجاد نرخ جدید</span></a></li>--}}
                            {{--<li class="nav-item"><a class="nav-link" href="toastr.html"><i class="menu_icon ti-layout-cta-left"></i> <span>لیست نرخ ها</span></a></li>--}}
