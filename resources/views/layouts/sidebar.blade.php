        ...
        <div class="navbar-content scroll-div">
            <div class="vz_navigation">
                <ul class="sidebar nav flex-column">
                    ...
                    <li><a class="nav-link text-center" href="javascript:void(0);" data-nav="ui_features"><i class="feather ft-gitlab"></i><span> بلاگ ها </span></a></li>
                ...
                <div class="sidebar_content">
                    ...
                    <div class="vz_sidebar_link ui_features">
                        <ul class="nav vz_inner_nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="alert.html"><i class="menu_icon ti-alert"></i><span>ایجاد بلاگ جدید</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="alert.html"><i class="menu_icon ti-alert"></i><span>  لیست بلاگ ها  </span></a></li>
