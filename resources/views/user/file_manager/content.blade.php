...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="row mt-3">
                <div class="col-2">
                    <img src="{{ asset('vendor/laravel-filemanager/img/152px color.png') }}" class="m-2 w-75">
                </div>
                <?php
                ...
                ?>
                <div class="col-10">
                    <p> فضای دیسک :  <span dir="ltr">{{$current_size}} Mb (Max : {{$total_size}} Mb)</span> </p>
            ...
            <div class="progress m-2" style="height: .5rem;">
            ...
            <div class="modal-body">
                @if(getFolderSize()<=getUser('disk_size'))
                    <form
                            action="{{ route('unisharp.lfm.upload') }}"
                            role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
