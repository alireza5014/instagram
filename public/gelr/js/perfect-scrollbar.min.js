...
! function (t, e) {
	...
	function b(t, i) {
		...
		i.isLrt ? r.right = i.negativeScrollAdjustment + t.scrollRight + i.containerWidth - i.contentWidth : r.right = t.scrollRight, i.isScrollbarXUsingBottom ? r.bottom = i.scrollbarXBottom - l : r.top = i.scrollbarXTop + l, e(i.scrollbarXRail, r);
		var n = {
			top: l,
			height: i.railYHeight
		};
		i.isScrollbarYUsingLeft ? i.isLtr ? n.left = i.contentWidth - (i.negativeScrollAdjustment + t.scrollRight) - i.scrollbarYLeft - i.scrollbarYOuterWidth : n.left = i.scrollbarYLeft - t.scrollRight : i.isLtr ? n.right = i.negativeScrollAdjustment + t.scrollRight + 2 * i.containerWidth - i.contentWidth - i.scrollbarYRight - i.scrollbarYOuterWidth : n.right = i.scrollbarYRight + t.scrollRight, e(i.scrollbarYRail, n), e(i.scrollbarX, {
			right: i.scrollbarXRight,
