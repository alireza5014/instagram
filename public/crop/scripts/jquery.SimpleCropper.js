...
(function ($) {
    ...
    $.fn.simpleCropper = function (w,h,w1,h1,onComplete) {

        var image_dimension_x = 400;
        var image_dimension_y = 400;
        ...
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><ul class='list-inline'><li class='cancel'></li><li class='ok'></li></ul></div></div>";
